        ...
        <div class="row">
            <div class="col-3">
                <div class="list-group">
                    ...
                    <a class="list-group-item active" href="menupage.php"><i class="fa fa-cutlery" aria-hidden="true"></i>&nbsp; Menu</a>
            ...
            <div class="col-9">
                ...
                if ($act == 'add') {
                        include('form_addMenu.php');
                    } elseif ($act == 'edit') {
                    include('form_editMenu.php');
                } else { ?>
                    <h2>All Menu</h2><br>
                    <!--======Add icon=====-->
                    <div class="section-intro">
                        <a class="btn btn-success" href="menupage.php?act=add"> +Add Menu</a>
                    </div>
                    <!--======Add icon end=====-->
                    <br>
