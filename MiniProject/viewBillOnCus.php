...
<body>
    ...
    <?php
        ...
        $query = "SELECT billID FROM bills,orders
        WHERE orders.customerID = $ID
        AND orders.orderID = bills.OrderID"
            ...
            while($row=mysqli_fetch_array($result)) {
                echo "<tbody>";
                    echo "<tr>";
                        ...
                        echo "<td>" .$row["bill_totalPrice"] .  "</td> ";
                        echo "<td>" .date('d-m-Y',strtotime($row["billsDate"])).  "</td> ";
                    echo "</tr>";
                echo "</tbody>";
            }
            echo "</table>";
