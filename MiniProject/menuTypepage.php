        ...
        <div class="row">
            <div class="col-3">
                <div class="list-group fixed">
                    ...
                    <a class="list-group-item active" href="menuTypepage.php"><i class="fa fa-database" aria-hidden="true"></i>&nbsp; Menu Type</a>
            ...
            <div class="col-9">
                ...
                if ($act == 'add') {
                        include('form_addmenuType.php');
                    } elseif ($act == 'edit') {
                    include('form_editmenuType.php');
                } else { ?>

                    <h2>All Menu Type</h2><br>
                    <!--======Add icon=====-->
                    <div class="section-intro">
                        <a class="btn btn-success" href="menuTypepage.php?act=add"> +Add Menu Type</a>
                    </div>
                    <br>
                    <!--======Add icon end=====-->
                    <?php include('menuTypetable.php');
                } ?>
