...
<body>
    ...
    <?php
        ...
        $query = "SELECT departments.deptName,belongto.empID,belongto.statusEmp,belongto.startDate,belongto.deptID
        FROM departments,belongto
        WHERE belongto.empID = $ID
        AND departments.deptID = belongto.deptID
        ORDER BY belongto.deptID DESC"
        ...
        $query2 = "SELECT * FROM employees WHERE empID='$ID'" or die("Error: ".mysqli_error($connectData));
        ...
        <h3><?php echo $row2["fistNameEmp"]; ?>   <?php echo  $row2["lastNameEmp"]; ?> Work on : <br><br></h3>
