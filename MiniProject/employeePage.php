        ...
        <div class="row">
            <div class="col-3">
                <div class="list-group">
                    ...
                    <a class="list-group-item active" href="employeePage.php"><i class="fa fa-id-card" aria-hidden="true"></i>&nbsp; Employee</a>
            ...
            <div class="col-9">
                ...
                if ($act == 'add') {
                        include('form_addEmp.php');
                    } elseif ($act == 'edit') {
                    include('form_editEmp.php');
                } elseif ($act == 'view') {
                    include('viewDeptOnEmpTable.php');
                } else { ?>
                    <h2>Employee</h2><br>
                    <!--======Add icon=====-->
                    <div class="section-intro">
                        <a class="btn btn-success" href="employeePage.php?act=add"> +Add New Employee<br></a>
                    </div>
                    <!--======Add icon end=====-->
                    <br>
